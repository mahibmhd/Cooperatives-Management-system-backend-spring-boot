...
import com.dxvalley.project.services.TotalCapitalService;
    ...
    public class PrCooperativeExportDataController {
        ...
        prCooperatives.stream().forEach(pr->{
            ...
            List<AnnualTurnOver> annualTurnOvers=annualTurnOverService.getAnnualTurnOverByPrCooperative(pr);
            //annualSellService.getAnnualSellByPrCooperative(pr); 
            List<AnnualTurnOverDto> annualTurnOverDtos= new ArrayList<AnnualTurnOverDto>();
            annualTurnOvers.stream().forEach(an->{
                AnnualTurnOverDto annualTurnOverDto = new AnnualTurnOverDto();
                annualTurnOverDto.setAnnualTurnOverValue(an.getAnnualTurnOverValue());
                annualTurnOverDto.setDateGenerated(an.getDateGenerated());
                annualTurnOverDtos.add(annualTurnOverDto);
            });
            prCooperativesExportData.setAnnualTurnOvers(annualTurnOverDtos);
           // .setAnnualSells(annualSellDtos);
